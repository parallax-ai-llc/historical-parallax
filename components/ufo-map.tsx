...
export function UfoMap({ locations }: UfoMapProps) {
    ...
    const [position, setPosition] = React.useState({ coordinates: [0, 0] as [number, number], zoom: 1 })
            ...
            >
                ...
                >
                    ...
                    {locations.map(({ name, coordinates, id }) => (
                        ...
                        >
                            <circle r={4 / position.zoom} fill="#ef4444" stroke="#ffffff" strokeWidth={1.5 / position.zoom} className="animate-pulse" />
