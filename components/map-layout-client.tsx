...
export function MapLayoutClient({ searchIndex, children }: MapLayoutClientProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <MapHeader onSearchClick={() => setSearchOpen(true)} />
...
function MapHeader({ onSearchClick }: MapHeaderProps) {
  return (
    <header
    ...
    >
      <div className="flex h-14 items-center justify-between px-4 md:px-6">
        ...
        <nav aria-label="Map navigation" className="flex items-center gap-2">
          <Button
            variant="outline"
