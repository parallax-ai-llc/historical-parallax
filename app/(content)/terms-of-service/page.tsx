  ...
  return (
    <div className="container py-12">
      <article className="prose mx-auto max-w-3xl">
        ...
        <p>
          All information is sourced from publicly available materials. We provide citations where
          possible, but users should verify information independently for critical uses.
        </p>
