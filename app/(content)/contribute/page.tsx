...
export function generateMetadata() {
  return {
    title: "Contribute to Historical Parallax",
    description: "Help us build a comprehensive, balanced resource on historical figures and events.",
  };
}
    ...
    <div className="bg-background overflow-x-hidden">
      <main className="container max-w-4xl py-12 px-4">
        <div className="space-y-2 mb-8">
          <h1 className="font-sans text-4xl font-bold tracking-tight">Contribute to Historical Parallax</h1>
          <p className="text-lg text-muted-foreground">Help us build a comprehensive, balanced resource on historical figures and events.</p>
        </div>
        ...
        <section className="space-y-4 mb-12">
          ...
          <p className="text-muted-foreground">
            We accept contributions in the form of Markdown files located in the <code className="px-1.5 py-0.5 rounded bg-muted font-mono text-sm">content/articles</code> directory. You can either create new articles or improve existing ones.
          </p>
        </section>
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div className="space-y-2 min-w-0 flex-1">
                ...
                <p className="text-muted-foreground">
                  Go to our <a href={GITHUB_REPO} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">GitHub repository</a> and click the &quot;Fork&quot; button to create your own copy.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-semibold">6</div>
              <div className="space-y-2 min-w-0 flex-1">
                <h3 className="font-semibold">Open a Pull Request</h3>
                <p className="text-muted-foreground">Go to your fork on GitHub and click &quot;Compare &amp; pull request&quot;. Provide a clear description of your contribution.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6 mb-12">
          ...
          <p className="text-muted-foreground">Every article must follow this exact Markdown structure:</p>
...
## References`}</code>
        ...
        <section className="space-y-6 mb-12">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="p-4 rounded-lg border bg-card">
              <div className="flex items-center gap-2 mb-2">
                <span className="h-5 w-5 rounded-full bg-red-500 flex items-center justify-center text-white text-xs">X</span>
        ...
        <section className="space-y-6 mb-12">
          ...
          <ol className="space-y-3 text-muted-foreground">
            <li className="flex gap-3"><span className="font-semibold text-foreground">1.</span>Navigate to the article page on our website</li>
            <li className="flex gap-3"><span className="font-semibold text-foreground">2.</span>Click the &quot;Edit&quot; button in the header to go directly to the file on GitHub</li>
            <li className="flex gap-3"><span className="font-semibold text-foreground">3.</span>Click the pencil icon on GitHub to edit the file</li>
            <li className="flex gap-3"><span className="font-semibold text-foreground">4.</span>Make your changes and submit a pull request</li>
          </ol>
          <div className="p-4 rounded-lg bg-muted/50 border">
            <p className="text-sm">
              Tip: You can also browse all articles directly at <a href={`${GITHUB_REPO}/tree/main/content/articles`} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">our GitHub repository</a>
            </p>
          </div>
        </section>
        ...
        <div className="flex flex-col items-center gap-4 py-8 text-center">
          ...
          <p className="text-muted-foreground max-w-md">Your contributions help create a more comprehensive understanding of history.</p>
