          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-2">
                ...
                <pre className="p-3 rounded-lg bg-muted overflow-x-auto text-sm">
...
git push origin feature/add-article-name`}</code>
        ...
        {/* Article Format */}
        <section className="space-y-6 mb-12">
          <h2 className="font-serif text-2xl font-semibold">Article Format</h2>
          <p className="text-muted-foreground">
            Every article must follow this exact Markdown structure:
          </p>

          <pre className="p-4 rounded-lg bg-muted overflow-x-auto text-sm leading-relaxed">
            <code>{`---
...
[^2]: Author, "Title" (Year). URL`}</code>
        ...
        {/* Guidelines */}
        <section className="space-y-6 mb-12">
          <h2 className="font-serif text-2xl font-semibold">Content Guidelines</h2>
        ...
        {/* Review Process */}
        <section className="space-y-4 mb-12">
          <h2 className="font-serif text-2xl font-semibold">Review Process</h2>
          <p className="text-muted-foreground">
        ...
        <div className="flex flex-col items-center gap-4 py-8 text-center">
          <h2 className="font-serif text-2xl font-semibold">Ready to Contribute?</h2>
